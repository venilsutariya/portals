        ...
        <VisibilitySensor onChange={onVisibilityChange} partialVisibility>
          <div>
            ...
            <div className=" flex lg:hidden justify-center">
              <img onClick={() => setShowSecond(true)} onMouseLeave={() => setIsHovering(false)} onMouseEnter={() => setIsHovering(true)} src="/images/project1.png" className=" w-[90%] cursorimg img-fluid cursor-pointer" alt="" />
            </div>
            ...
            <div className=" flex lg:hidden justify-center">
              <img onClick={() => setShowSecond(true)} onMouseLeave={() => setIsHovering(false)} onMouseEnter={() => setIsHovering(true)} src="/images/project3.png" className=" w-[90%] cursorimg img-fluid cursor-pointer" alt="" />
            </div>
            ...
            <div className=" flex lg:hidden justify-center">
              <img onClick={() => setShowSecond(true)} onMouseLeave={() => setIsHovering(false)} onMouseEnter={() => setIsHovering(true)} src="/images/project4.png" className=" w-[90%] cursorimg img-fluid cursor-pointer" alt="" />
            </div>
