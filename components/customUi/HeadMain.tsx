      ...
      <div className=" headmain">
        <div className="bgmainimg text-white">
          <div className=" flex flex-col justify-center items-center h-full text-center">
            ...
            <div className="animatediv xl:text-6xl lg:text-6xl md:text-5xl text-4xl flex flex-col gap-y-3">
            ...
            <div className=" flex w-full justify-center items-center gap-x-4 mt-3 animate__animated animate__slideInUp">
