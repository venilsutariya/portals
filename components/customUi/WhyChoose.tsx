        ...
        <VisibilitySensor onChange={onVisibilityChange} partialVisibility>
            <div style={{ backgroundColor: '#000212' }} className="">
                <div className={`whychoose ${isVisible ? 'animate__animated animate__slideInUp' : ''}`}>
                    ...
                    <div className=" px-2 bg-red-300" style={{display: 'flex' , justifyContent: 'end'}}>
                        <div className=" row bg-red-500 container flex row-cols-1 row-cols-lg-3 gap-y-10 pb-5 px-0 g-0">
