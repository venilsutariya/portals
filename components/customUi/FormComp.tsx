...
const FormComp = () => {
    ...
    return (
        <VisibilitySensor onChange={onVisibilityChange} partialVisibility>
            <div>
                <div className={`pb-20 flex flex-col text-center text-white text-3xl ${isVisible ? 'animate__animated animate__slideInUp' : ''}`}>
                ...
                <div className=" row g-0 p-0">
                    <div className={`col relative ${isVisible ? 'animate__animated animate__slideInUp' : ''}`}>
                        ...
                        <div className=" absolute text-white top-20 left-44 text-lg">We are Portals and we are here to serve you :)</div>
                    </div>
                    <div className={` col relative ${isVisible ? 'animate__animated animate__slideInUp' : ''}`}>
                        <div className="absolute top-20 w-full pe-44">
                            <form className="">
