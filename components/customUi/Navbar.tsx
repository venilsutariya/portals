            ...
            <Navbar expand="lg" className=" px-lg-5 px-4 pt-4">
                ...
                <Navbar.Collapse id="basic-navbar-nav" className=' me-0 me-lg-5'>
                    <Nav className="ms-auto" style={{ fontSize: '17px' }}>
                        ...
                        <Link href="#usecases" className=' me-5 no-underline' style={{ color: '#B4BCD0' }}>Scope of service</Link>
                        <Link href="#plans" className=' no-underline' style={{ color: '#B4BCD0' }}>Plans</Link>
                    </Nav>
                </Navbar.Collapse>
            </Navbar>
        </>
